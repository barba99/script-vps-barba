...
valid_fun () {
echo -e "${cor[2]}Clave valida! Instalando ... "
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
...
echo -e "${cor[3]}Ahora se instalaran las dependencias "
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
cd /etc/adm-lite
chmod +x ./*
instalar_fun
...
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[3]}¡Procedimiento exitoso! "
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[3]} |∆| Gracias Por Su Confianza"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[2]}Use Los Comandos: menu o adm"
echo -e "${cor[2]}De acceso al script, Buen uso!"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -ne " \033[0m"
}
verify_fun () {
...
unset serial
unset server
echo -ne "\033[1;33mSu Key!: \033[1;37m"; read serial
...
rm $HOME/tmp
    [[ $var = "" ]] && {
    echo -e "${cor[2]}INVALIDA..."
    echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
    echo -ne "${cor[2]}Intentar Con Otra Key? [S/N]: "; read other
...
error_fun () {
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "\033[1;31mSistema no compatible"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -ne "\033[0m"
exit 1
}
